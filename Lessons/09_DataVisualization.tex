...
\StringTok{  }\KeywordTok{scale_color_manual}\NormalTok{(}\DataTypeTok{labels =} \KeywordTok{expression}\NormalTok{(}\StringTok{"NH34"}\NormalTok{,}\StringTok{"NO23"}\NormalTok{,}\StringTok{"PO4"}\NormalTok{,}\StringTok{"TN"}\NormalTok{,}\StringTok{"TP"}\NormalTok{),}

...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-2-2.pdf}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-2-3.pdf}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-2-4.pdf}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-2-5.pdf}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-3-2.pdf}
...
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{, }\DataTypeTok{size =} \FloatTok{1.5}\NormalTok{) }\OperatorTok{+}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-4-1.pdf}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-5-1.pdf}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-5-2.pdf}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-5-3.pdf}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-5-4.pdf}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-5-5.pdf}
...
\StringTok{  }\CommentTok{# note: the labs function allows you to relabel anything specified as an aesthetic in the first line}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \KeywordTok{expression}\NormalTok{(TP }\OperatorTok{~}\StringTok{ }\NormalTok{(mu}\OperatorTok{*}\NormalTok{g }\OperatorTok{/}\StringTok{ }\NormalTok{L)), }\DataTypeTok{y =} \KeywordTok{expression}\NormalTok{(TN }\OperatorTok{~}\StringTok{ }\NormalTok{(mu}\OperatorTok{*}\NormalTok{g }\OperatorTok{/}\StringTok{ }\NormalTok{L)),}
       \DataTypeTok{color =} \StringTok{"Depth (m)"}\NormalTok{, }\DataTypeTok{shape =} \StringTok{""}\NormalTok{) }\OperatorTok{+}\StringTok{ }
...
\StringTok{  }\KeywordTok{scale_color_viridis}\NormalTok{(}\DataTypeTok{option =} \StringTok{"magma"}\NormalTok{, }\DataTypeTok{direction =} \DecValTok{-1}\NormalTok{, }\DataTypeTok{end =} \FloatTok{0.8}\NormalTok{) }\OperatorTok{+}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-5-6.pdf}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{""}\NormalTok{, }\DataTypeTok{y =} \KeywordTok{expression}\NormalTok{(Concentration }\OperatorTok{~}\StringTok{ }\NormalTok{(mu}\OperatorTok{*}\NormalTok{g }\OperatorTok{/}\StringTok{ }\NormalTok{L)), }\DataTypeTok{color =} \StringTok{"Nutrient"}\NormalTok{) }\OperatorTok{+}
...
\StringTok{   }\CommentTok{#scale_color_brewer(palette = "YlGnBu", values = (n = 9)[4:9],}
\StringTok{   }\CommentTok{#                   labels = c(expression(NH[4]^\{"+"\}), expression(NO[3]^\{"-"\}),}
\StringTok{   }\CommentTok{#                              expression(PO[4]^\{"3-"\}), "TN", "TP")) +}
\StringTok{   }\KeywordTok{scale_color_manual}\NormalTok{(}\DataTypeTok{values =} \KeywordTok{c}\NormalTok{(}\StringTok{"#7fcdbb"}\NormalTok{, }\StringTok{"#41b6c4"}\NormalTok{, }\StringTok{"#1d91c0"}\NormalTok{, }\StringTok{"#225ea8"}\NormalTok{, }\StringTok{"#0c2c84"}\NormalTok{),}
                      \DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\KeywordTok{expression}\NormalTok{(NH[}\DecValTok{4}\NormalTok{]}\OperatorTok{^}\NormalTok{\{}\StringTok{"+"}\NormalTok{\}), }\KeywordTok{expression}\NormalTok{(NO[}\DecValTok{3}\NormalTok{]}\OperatorTok{^}\NormalTok{\{}\StringTok{"-"}\NormalTok{\}),}
                               \KeywordTok{expression}\NormalTok{(PO[}\DecValTok{4}\NormalTok{]}\OperatorTok{^}\NormalTok{\{}\StringTok{"3-"}\NormalTok{\}), }\StringTok{"TN"}\NormalTok{, }\StringTok{"TP"}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\CommentTok{#scale_color_viridis(discrete = TRUE, option = "magma", end = 0.8,}
\StringTok{  }\CommentTok{#                    labels = c(expression(NH[4]^\{"+"\}), expression(NO[3]^\{"-"\}),}
\StringTok{   }\CommentTok{#                             expression(PO[4]^\{"3-"\}), "TN", "TP")) +}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position =} \StringTok{"right"}\NormalTok{)}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-5-7.pdf}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-6-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#align: "t" (top), "r" (right), "b" (bottom), and "l" (left)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-7-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Neonics}\OperatorTok{$}\NormalTok{Endpoint <-}\StringTok{ }\KeywordTok{reorder}\NormalTok{(Neonics}\OperatorTok{$}\NormalTok{Endpoint, Neonics}\OperatorTok{$}\NormalTok{Endpoint, }\DataTypeTok{FUN =}\NormalTok{ length)}

\NormalTok{Neonics.plot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(Neonics, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Endpoint)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{fill =} \StringTok{"#7fcdbb"}\NormalTok{, }\DataTypeTok{color =} \StringTok{"black"}\NormalTok{, }\DataTypeTok{size =} \FloatTok{0.25}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_discrete}\NormalTok{(}\DataTypeTok{limits =} \KeywordTok{rev}\NormalTok{(}\KeywordTok{levels}\NormalTok{(Neonics}\OperatorTok{$}\NormalTok{Endpoint))) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{y =} \StringTok{"Number of Publications with reported endpoint"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{45}\NormalTok{, }\DataTypeTok{hjust =} \DecValTok{1}\NormalTok{))}
\KeywordTok{print}\NormalTok{(Neonics.plot)}
\end{Highlighting}
\end{Shaded}

\includegraphics{09_DataVisualization_KEY_files/figure-latex/unnamed-chunk-7-2.pdf}

...
* **Documentation** of data pipline steps
* Store *code*, *visualizations*, and *test* in one place
* **Organize** code into sections
* Asthetically pleasing 
* Manage changes in a *reproducible* fashion

1.organize neat looking final product
2.data visualization + report writing process
3.run and display chunks of codes

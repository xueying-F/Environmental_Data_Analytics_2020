...
```{r}
#1
Ozone.plot1 <- ggplot(EPAair, aes(x = Ozone, color= as.factor(Year))) +
  #geom_density(stat = "count", fill = "gray") +  #show actually counts
  geom_density(fill = "gray") + #density is moving average
  geom_vline(xintercept = 50, color = "#238b45", lty = 2, size = 0.9) + #lty:line type=2 is dash
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0))
...
#2
Ozone.plot2 <- ggplot(EPAair, aes(x = Ozone), color = as.factor(Year)) +
  stat_summary(aes(y = Year), fun.y = "mean")+
  geom_boxplot() +
  geom_density(fill = "gray") + #density is moving average
  geom_vline(xintercept = 50, color = "#238b45", lty = 2, size = 0.9) + #lty:line type=2 is dash
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0))

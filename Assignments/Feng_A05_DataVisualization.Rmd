...
Tempplot <-
  ...
  labs(y=expression(paste("Temperature (℃)")))+
  #ylim = range(0:120)+                             #I would like to change y scale but it does not work
...
#cowplot" sometimes does not work
dev.off() #stack overflow give this methods
...
> Answer:  I think #7 is more effective, because it is more clear to see dry mass of each lass. In #6, all classes data overlap, which is hard to distinguish.
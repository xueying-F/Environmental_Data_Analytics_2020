...
# 6
GaringerOzone <- left_join(GaringerOzone_Wrangle, Days, by ='Date')
...
> Answer: In linear interpolation, the estimated point is assumed to lie on the line joining the nearest points to the left and right.
...
GaringerOzone.monthly <-  GaringerOzone %>%
  ...
  group_by(Year, Month) %>%  
  summarise(OzoneConcentration = mean(Daily.Max.8.hour.Ozone.Concentration)) # columns will be Year, Month, OzoneConcentration

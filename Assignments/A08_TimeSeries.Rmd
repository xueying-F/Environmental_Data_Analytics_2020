...
> Answer:  First, seasonalvariations of ozone concentration repeat over a specific period almost one year; Second, trend variations ozone concentration move up in first six months of year and move down in second six months of year, which is a reasonably predictable pattern. However, the maximum of ozone concentration varies a lot, but overall ozone concentrations have little changed over the 2010s at this station. (z = -2.0146, p-value = 0.04394)

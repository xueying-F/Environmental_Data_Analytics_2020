...
> Answer: I think the seasonal Mann-Kendall should be one year, so I set frequency as 12, because every year have the same trend.
...
summarize(GaringerOzone.monthly.trend)

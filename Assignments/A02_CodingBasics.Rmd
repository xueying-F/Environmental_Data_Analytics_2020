...
Score1 <- Pass(80); Score1
Score2 <- Pass(70); Score2
Score3 <- Pass(95); Score3
Score4 <- Pass(45); Score4
...
> Answer: Bothe of them worked for this question, However, if there are more than two outcomes, `if` and `else ` should be used instead of `ifelse`.
